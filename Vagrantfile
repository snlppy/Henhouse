Vagrant.configure("2") do |config|
  ...
  config.vm.provision "shell", inline: "netsh interface ip set address \"Ethernet 2\" static 192.168.30.100 255.255.255.0 192.168.30.1",  privileged: true
  ...
  #pillow
  config.vm.provision "file", source: "python/Pillow-6.0.0.tar.gz", destination:"C:\\Users\\vagrant\\Desktop\\"
  config.vm.provision "shell", inline: "c:\\python27\\python.exe -m pip install C:\\Users\\vagrant\\Desktop\\Pillow", privileged: true #todo:check if it needs to be privilaged
